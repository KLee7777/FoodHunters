...
//     document.querySelector("#postUsername").innerHTML. postList[index].userName;
//     document.querySelector("#postimg").src= postList[index].userImageURL;
//     document.querySelector("#postContent").innerHTML. postList[index].postContent;
//     document.querySelector("#postDate").innerHTML. postList[index].postDate;
//     document.querySelector("#modalTime").innerHTML. postList[index].postTime;
